...
# ----- TODO LIST -----
# Фото после подтверждения доставки экрана доставок
# Уведомление на куар код когда есть приехавшие незабранные
# Сделать уведомление о том что медиа принято пользователю
# Переделать логику рассылки сообщений о новом выкупе
...
VALIDATE_CLBK = ('val|pos|{}|{}|{}',
                 'val|neg|{}|{}|{}')
ACCEPT_CLBK = ('accept|{}', 'reject|{}')
LONG_SLEEP = 20
MAX_LEN_NAME = 20
MAX_LEN_SURNAME = 25
AWARD_BUYOUT = 80
